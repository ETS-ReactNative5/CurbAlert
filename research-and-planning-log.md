...
- **2:33AM - 2:57AM** Add ios icons
- **2:57AM - 3:26AM** Bugfix: get image loader working! Try adding placeholder image (not displaying as expected).
- **3:26AM - 3:47AM** Make ItemDetail buttons only work within 500 ft of item
- **3:47AM - 3:57AM** Add TimeOut param to hide messages after 10 second
- **3:57AM - 4:05AM** Improve thumbs_up functionality
- **4:05AM - 4:14AM** Update all message handling
- **4:14AM - 4:26AM** Change ItemList button positioning to absolute
- **4:26AM - 4:32A2M** Change ItemList 'Loading...' to logo image when loading
- **4:32AM - 4:37AM** Add validation to require an image when creating new item
- **4:37AM - 5:02AM** Disable take button for items with 'cannot_take: true' property
